...
name = "Frisk & Chara"
description = "Let's go, just me and you."
author = "Arcade、いち夜によって編集。"
version = "CC by Arcade - Limited!" -- This is the version of the template. Change it to your own number.
...
{
    {
        ...
        hover = "This is the key use to transform Frisk.",
        options =
        {
